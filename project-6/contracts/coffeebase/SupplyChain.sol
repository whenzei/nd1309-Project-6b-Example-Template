...
contract SupplyChain is DistributorRole, ConsumerRole, FarmerRole, RetailerRole {
  ...
  onlyRetailer()
  {
    ...
    items[_upc].productRetailPrice = items[_upc].productPrice  * 115 / 100;
    // Emit the appropriate event
    emit Received(_upc);
  }
  ...
  onlyConsumer()
  received(_upc)
  paidEnough(items[_upc].productRetailPrice)
  checkValue(items[_upc].productRetailPrice)
  {
    ...
    uint retailPrice = items[_upc].productRetailPrice;
    (items[_upc].retailerID).transfer(retailPrice);
    // Emit the appropriate event
    emit Purchased(_upc);
  }
  ...
  ) 
  {
    ...
    productRetailPrice = items[_upc].productRetailPrice;
